...
<body>
  ...
  <main>
    ...
    <form class="form-container" id="registration-form">
      <h2>Rekistöröidy</h2>
      <label class="form-label" for="register-etunimi">Etunimi:</label>
      <input class="form-input" type="text" id="register-etunimi" name="etunimi" required>
      <label class="form-label" for="register-sukunimi">Sukunimi:</label>
      <input class="form-input" type="text" id="register-sukunimi" name="sukunimi" required>
      <label class="form-label" for="register-email">Sähköposti:</label>
