...
<body>
  ...
  <main>
    ...
    <!-- Login form -->
    <form class="form-container" id="loginForm" method="post" action="checklogin.php">
      <h2>Kirjaudu sisään</h2>
      <label class="form-label" for="email">Sähköposti:</label>
      <input class="form-input" type="email" name="email" id="email" required>
      <label class="form-label" for="password">Salasana:</label>
      <input class="form-input" type="password" name="salasana" id="password" required>
      <input class="form-submit" type="submit" value="Kirjaudu">
      <input class="form-button" type="button" onclick="location.href='register.php';" value="Rekisteröidy" />
      <?php
